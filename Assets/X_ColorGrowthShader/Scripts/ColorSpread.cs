...
namespace ColorGrowth
{
    [Serializable]
    [PostProcess(typeof(ColorSpreadRenderer), PostProcessEvent.AfterStack, "ColorGrowth/Grayscale")]
    ...
    public sealed class ColorSpreadRenderer : PostProcessEffectRenderer<ColorSpread>
    {
        public override void Render(PostProcessRenderContext context)
        {
            ...
            var sheet = context.propertySheets.Get(Shader.Find("ColorGrowth/ColorGrowth"));
